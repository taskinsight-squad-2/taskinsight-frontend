          ...
          >
            ...
            {!forgotMode && tab === "register" && (
              ...
              >
                ...
                <div
                  className={`rounded-xl border ${dark ? "border-white/8 bg-white/[0.02]" : "border-slate-200 bg-slate-50"} overflow-hidden`}
                >
                  <button
                    type="button"
                  ...
                  >
                    <span className="flex items-center gap-2">
                      ...
                      {t.personalizeSection}{" "}
                      <span
                        className={`text-[10px] font-normal ${dark ? "text-white/35" : "text-slate-400"}`}
                      >
                        {t.optionalLabel}
                      </span>
                    </span>
                    <svg
                      ...
                      strokeLinejoin="round"
                      style={{
                        transform: showA11y ? "rotate(180deg)" : "rotate(0deg)",
                  ...
                  {showA11y && (
                    <div
                      id="a11y-prefs-panel"
                      className={`px-4 pb-4 border-t ${dark ? "border-white/8" : "border-slate-200"}`}
                    >
                      <div
                        className={`flex items-start gap-2 mt-3 mb-3 px-3 py-2.5 rounded-lg border ${dark ? "bg-violet-500/10 border-violet-500/25 text-violet-300" : "bg-violet-50 border-violet-200 text-violet-700"}`}
                      >
                        <svg
                          aria-hidden="true"
                          width="13"
                      ...
                      <fieldset className="mb-3">
                        <legend
                          className={`text-[10px] font-bold uppercase tracking-widest ${dark ? "text-white/55" : "text-slate-500"} mb-2`}
                        >
                          {t.a11yVision}
                        </legend>
                        <div className="flex flex-col gap-1.5">
                          {(
                            ...
                            <label
                              key={key}
                              className={`flex items-center gap-2.5 text-xs cursor-pointer ${dark ? "text-white/80" : "text-slate-700"}`}
                            >
                              <input
                                type="checkbox"
                                checked={prefs[key]}
                      ...
                      <fieldset>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          >
                            <input
                              type="checkbox"
                              checked={prefs.speechMode}
                              onChange={() =>
                                togglePref("speechMode", t.a11ySpeech)
                              }
                              className="w-3.5 h-3.5 rounded accent-violet-600 cursor-pointer"
                            />
